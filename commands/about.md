...
- `/vibe:create spec: Rate limiting for summarizer | Prevent LLM cost overruns` — spec with brief
- `/vibe:create decision: Use PostgreSQL` — decision
- `/vibe:create issue: Auth tokens not invalidated on logout`
